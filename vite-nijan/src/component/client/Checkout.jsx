		...
		<section class="shop checkout section">
			<div class="page-container">
				<div class="grid grid-cols-4 gap-2"> 
					<div class="col-span-3  border-[1px] border-slate-100 p-5">
								...
								<div class="grid grid-cols-2 gap-3">
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group flex flex-col">
											<label class="w-fit">Country<span>*</span></label>
											<select class="p-4 transition-all bg-white border border-gray-100 rounded-md outline-none focus:border-black">
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group flex flex-col">
											<label class="w-fit">State / Divition<span>*</span></label>
											<select class="p-4 transition-all bg-white border border-gray-100 rounded-md outline-none focus:border-black">
									...
									<div class="col-lg-6 col-md-6 col-12">
										<div class="form-group flex flex-col">
											<label class="w-fit">Company<span>*</span></label>
											<select class="p-4 transition-all bg-white border border-gray-100 rounded-md outline-none focus:border-black">
					...
					<div>
						<div class="order-details">
							...
							<div class="single-widget get-button">
								<div class="content">
                                <Button
                                    className="px-3 py-4 transition-all bg-orange-500 rounded-none hover:bg-orange-300"
                                    >
                                    Proceed to checkout
                                </Button>
								</div>
